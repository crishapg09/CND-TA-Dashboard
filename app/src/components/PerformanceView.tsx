  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(230px, 100%), 1fr))', gap: 16, marginTop: 16, alignItems: 'start' }}>
        <Hero bg="#EAF2F8" border="#CFE0EE" labelColor="#0B6FA4" value={d.recent} valueColor="#0B6FA4" label="Received in last 30 days" body="new TA requests opened between 7 Jul and 6 Aug 2026." bodyColor="#3E6178" />
      ...
      <RequestTable
        ...
        daysColor="#C0453F"
        footer="Days over = today (6 Aug 2026) − the request’s Expected Completion Date, counting only active requests (implementation status below 100%) whose target date has already passed."
      />
